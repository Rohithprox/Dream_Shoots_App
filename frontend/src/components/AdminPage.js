      ...
      <div className="max-w-7xl mx-auto mb-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-[var(--ds-border)] pb-6">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3 pr-4 md:pr-6 border-r border-[var(--ds-border)]">
              <img src="/Dream Shoots Logo.svg" alt="Dream Shoots" className="h-8 md:h-10" />
              <span className="text-gray-500 text-[10px] md:text-sm font-medium whitespace-nowrap">Admin Panel</span>
            </div>
            <nav className="flex items-center gap-1 overflow-x-auto no-scrollbar pb-2 md:pb-0">
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-lg text-xs md:text-sm font-medium transition-all whitespace-nowrap ${activeTab === tab.id
